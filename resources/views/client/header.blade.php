            ...
            <ul class="nav-left" >
                ...
                <li class="dropdown switcher  switcher-language">
                    ...
                    <ul class="dropdown-menu switcher-options ">
                        <li class="switcher-option">
                            <a href="#">
                                <img class="switcher-flag" alt="flag" src="/client/images/flags/flag_english.png">English
                            </a>
                        </li>
                        <li class="switcher-option">
                            <a href="#">
                                <img class="switcher-flag" alt="flag" src="/client/images/flags/flag_french.png">French
                            </a>
                        </li>
                        <li class="switcher-option">
                            <a href="#">
                                <img class="switcher-flag" alt="flag" src="/client/images/flags/flag_germany.png">Germany
                            </a>
                        </li>
                    </ul>
                </li>
